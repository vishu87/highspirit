...
$res_shop = mysql_query("SELECT id, name from shops_english where group_name = '$grp'");
...
$query = "SELECT shop_id, size_id, SUM(old_stock) as old_stock from sale_english where shop_id IN (".$shop_string.") and timestamp_day = $time_pre GROUP BY shop_id, size_id";
...
$query = "SELECT shop_id, size_id, SUM(final_stock) as final_stock from sale_english where shop_id IN (".$shop_string.") and timestamp_day = $time_nxt GROUP BY shop_id, size_id";
...
$array_sale = array();
$query = "SELECT shop_id, size_id, SUM(stock_in) as stock_in, SUM(stock_transfer) as stock_transfer, SUM(sale) as sale, SUM(rate*sale) as rate, SUM(total_cost) as total_cost from sale_english where shop_id IN (".$shop_string.") and timestamp_day between $time_pre and $time_nxt GROUP BY shop_id, size_id";
...
$query = "SELECT shop_id, SUM(total_sum) as total_sum from sale_english_sum_final where shop_id IN (".$shop_string.") and timestamp_day between $time_pre and $time_nxt and type_id = 0 GROUP BY shop_id";
