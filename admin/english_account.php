...
<body class="home" >
	...
	<div id="date_change" style="background:#eee; padding:20px; margin-bottom:20px;" align="center">
		...
		<form action="process_english_account.php" method="post" target="_blank">
			<table>
				<tr>
					<td>ग्रुप</td>
					<td>
						<select name="grp" id="grp" onchange="fetch_shop_english()">
							<?php
								$count =0;
	...
	<form action="process_english_account_shop.php" method="post" target="_blank">
			<table>
				<tr>
					<td>ग्रुप</td>
					<td>
...
function fetch_shop_english(){
     
     var file = "fetch_shop_english";
     var id = $("#grp").val();
     $.post(""+ file +".php", {id:id}, function(data) {
     	$("#shop").html(data);
   });
