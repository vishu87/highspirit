<?php include('top.php'); 
$dis = array("अम्बेडकर नगर","फैजाबाद", "सुल्तानपुर","लखनऊ ");
...
$type =3;
$dis_names=array("","अकबरपुर","जलालपुर","भीटी","टाण्डा","बसखारी","जहांगीरगंज","फैजाबाद","सुल्तानपुर","लखनऊ");
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="home" onload="initialize();">
	...
	<div id="nav_group">
 		<div id="groups">
 			<ul>
 				<?php 
	 				$groups = mysql_query("SELECT DISTINCT group_name from shops where district = '$current_district' ");
	 				$count =1;
