...
for($i=1; $i<=$total_sizes;$i++){
	...
	mysql_query("DELETE from sale_english_final where shop_id='$shop_id' and timestamp_day = '$timedate' and size_id = '$size_id' ");

	mysql_query("INSERT into sale_english_final (shop_id, timestamp_day,  size_id, old_stock, stock_in, stock_transfer, initial_stock, final_stock, sale, total_cost) values ('$shop_id','$timedate', '$size_id','".$_POST["total_old_stock_".$size_id]."', '".$_POST["total_stock_in_".$size_id]."', '".$_POST["total_stock_transfer_".$size_id]."', '".$_POST["total_initial_stock_".$size_id]."', '".$_POST["total_final_stock_".$size_id]."', '".$_POST["total_sale_".$size_id]."', '".$_POST["total_total_cost_".$size_id]."') ");
}

mysql_query("DELETE from sale_english where shop_id='$shop_id' and timestamp_day = '$timedate' and type_id='0' ");
...
mysql_query("INSERT into sale_english_sum_final (shop_id, timestamp_day, total_sum, money_given, money_name, other_money, remark, final_total ) values ('$shop_id','$timedate','".$_POST["total_total_sum"]."','".$_POST["money_given"]."','".$_POST["money_name"]."','".$_POST["other_money"]."','".$_POST["remark"]."','".$_POST["final_total"]."') ");
